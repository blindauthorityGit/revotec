    ...
    return (
        <>
            ...
            <SubPageHero
                title={
                    <>
                        <span className="text-primaryColor-500"> News & Insights </span>rund um Bau, Technik und ESG
                    </>
                }
                subtitle="Aktuelles Wissen, Projektupdates und Einblicke in unsere Arbeit – regelmäßig für Sie aufbereitet."
